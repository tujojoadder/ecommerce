...
/* Route::get('/get/district/{division_id}', [FrontendController::class, 'getdistrict'])->name('get.district');
Route::get('/get/upazila/{district_id}', [FrontendController::class, 'getUpazila'])->name('get.upazila');
