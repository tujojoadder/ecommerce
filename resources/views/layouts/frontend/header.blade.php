                                ...
                                <div class="login-modal-right">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="login" role="tabpanel">
                                            ...
                                            <fieldset class="form-group">
                                                <button type="submit" class="btn btn-lg btn-secondary btn-block">Enter
                                                    to your
                                                    account</button>
                                            </fieldset>
...
@if (request()->routeIs('home') || request()->routeIs('checkout'))
...
<nav class="navbar navbar-light navbar-expand-lg bg-dark bg-faded osahan-menu ">
    <div class="container-fluid">
        <a class="navbar-brand" href="/"> <img src="{{ asset('frontend/assets/img/logo.png') }}"
                alt="logo">
        </a>
        <a class="location-top" href="#"><i class="mdi mdi-map-marker-circle" aria-hidden="true"></i> New
            York</a>
            ...
            <div class="my-2 my-lg-0">
                <ul class="list-inline main-nav-right">
                    <li class="list-inline-item">
                        <a href="#" data-target="#bd-example-modal" data-toggle="modal"
...
<nav class="navbar navbar-expand-lg navbar-light osahan-menu-2 pad-none-mobile m-0">
    <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0 margin-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">Fruits & Vegetables</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Grocery & Staples</a>
                </li>
